...
export async function getBillingData(): Promise<BillingData> {
  ...
  // payments has no FKs — merge attribution client-side
  ...
  return {
    payments, invoices, payouts, ledger, balances,
    totals: {
