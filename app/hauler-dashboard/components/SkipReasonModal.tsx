...
export default function SkipReasonModal({ isOpen, onClose, onSubmit }: SkipReasonModalProps) {
                ...
                {REASONS.map((reason) => (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-xl border-2 transition-all ${
                      selectedReason === reason ? 'border-orange-500 bg-orange-500/10 text-orange-400' : 'border-slate-800 hover:bg-slate-800 text-gray-300'
                    }`}
                  >
