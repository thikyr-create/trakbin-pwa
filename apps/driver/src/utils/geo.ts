...
// Calculate total distance, safely handling undefined coordinates
export const calculateTotalDistanceKm = (stops: { latitude?: number; longitude?: number }[]): number => {
  ...
  for (let i = 0; i < stops.length - 1; i++) {
    ...
    if (p1.latitude !== undefined && p1.longitude !== undefined &&
      ...
      totalDistance += calculateDistanceInMeters(p1.latitude, p1.longitude, p2.latitude, p2.longitude);
    }
  }
